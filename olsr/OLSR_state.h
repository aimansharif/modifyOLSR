...
class OLSR_state : public cObject
{
  ...
  protected:
    ...
    //inline  hnaset_t&     hnaset() { return hnaset_;}
    ...
    //OLSR_association_tuple* find_association_tuple(const nsaddr_t &, const netaddr_t &);
    OLSR_association_tuple* find_association_tuple(OLSR_association_tuple*);
    void            erase_association_tuple (OLSR_association_tuple*);
    void            insert_association_tuple (OLSR_association_tuple*);

    OLSR_association* find_association(OLSR_association*);
